...
namespace HuduAPI.Endpoints.Parameters
{
    ...
    public class UpdateWebsiteBuilder : WebsiteBuilder<UpdateWebsite, UpdateWebsiteBuilder>
    {
        ...
        /// </summary>
        /// <param name="id">The identifier of the website.</param>
        /// <param name="name">The name to set the website too.</param>
        /// <param name="companyId">The company identifier to associated the website with.</param>
