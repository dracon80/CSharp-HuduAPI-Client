...
namespace HuduAPI.Endpoints.Parameters.AbstractBases
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Website" /> class with the minimum requried
        /// properties to get a new website.
        /// </summary>
        /// <param name="name">
        ...
        /// </param>
        internal Website(string name, int companyId)
        {
            this.Name = name;
