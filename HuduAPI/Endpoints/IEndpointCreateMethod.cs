...
{
    /// <summary>
    /// All Endpoints that implement a Create call must implement this internal interface. The
    /// interface at this point in only used to standardise the way Create methods are written and
    /// the interface is not directly used to initiate any objects.
    /// </summary>
    /// <typeparam name="TResult">
    /// The type that will be returned when calling the Create Method. The Type must implement the
    ...
    /// </typeparam>
    internal interface IEndpointCreateMethod<TResult, TParams>
